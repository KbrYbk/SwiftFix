...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a href="{{url('/#review')}}" class="nav-link">Отзывы</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{url('/HowToContact')}}" class="nav-link">Контактная информация</a>
                        </li>
                    </ul>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a href="tel:+79991234567" class="nav-link">+7(999)-123-45-67</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <footer class="text-center" data-aos="fade-up">
        ...
        <div class="social_media d-flex">
            ...
            <a href="https://vk.com/axaxaxaxaxaxaxxxaxaxaxaxaxaxaxax" target="_blank" rel="noopener noreferrer" class="social_media_icon">
                <svg width="44" height="44" viewBox="0 0 44 44" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="http://" target="_blank" rel="noopener noreferrer" class="social_media_icon">
                <svg width="44" height="44" viewBox="0 0 44 44" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
